...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <h1 className="transaition duration-700 text-center mb-8 cursor-pointer hover:text-indigo-600 text-3xl font-semibold">
      ...
      <p className="text-center text-lg text-gay-700 font-normal px-4 lg:p-20 mb-8 ">
        {post.excerpt}
      </p>
